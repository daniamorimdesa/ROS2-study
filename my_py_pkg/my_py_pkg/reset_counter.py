...
"""
Este node serve para chamar um serviço que reseta um contador(nesse caso, o node number_counter.py).
Ele cria um service client que envia uma request para resetar o contador
e processa a response recebida do service.

- service client: chama o serviço "reset_counter"
"""
