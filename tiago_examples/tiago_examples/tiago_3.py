...
continuação do tiago_2.py: manter o tiago se movendo no mundo sem bater nos obstáculos,
ou seja, lendo o laser e ajustando a velocidade angular para evitar colisões.
"""
